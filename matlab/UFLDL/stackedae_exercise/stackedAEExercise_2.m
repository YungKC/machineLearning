...
% need to lower lambda for better convergence.
lambda = 1e-4;
options.HessUpate = 'lbfgs'; % Here, we use L-BFGS to optimize our cost
                          % function. Generally, for minFunc to work, you
                          % need a function pointer with two outputs: the
...
% save ('result/stackedAEOptTheta_2.mat', 'stackedAEOptTheta');
% save ('result/stackedAEOptThetaSmallDataSet.mat', 'stackedAEOptTheta');

load('result/stackedAEOptTheta.mat');
