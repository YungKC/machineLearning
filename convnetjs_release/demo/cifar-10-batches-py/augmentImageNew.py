...
srcFiles = [os.path.join(os.getcwd(),'..','chiquita','ducky3.jpg'), os.path.join(os.getcwd(),'..','chiquita','hawaii56x100screenshot.jpg'), os.path.join(os.getcwd(),'..','chiquita','kid3.jpg'),os.path.join(os.getcwd(),'..','chiquita','maid3.jpg'), os.path.join(os.getcwd(),'..','chiquita','santa3.jpg'), os.path.join(os.getcwd(),'..','chiquita','stash3.jpg'), os.path.join(os.getcwd(),'..','chiquita','logoDucky.jpg'), os.path.join(os.getcwd(),'..','chiquita','logoHawaii.jpg'), os.path.join(os.getcwd(),'..','chiquita','logoKid.jpg'), os.path.join(os.getcwd(),'..','chiquita','logo.jpg'), os.path.join(os.getcwd(),'..','chiquita','logo1.jpg'), os.path.join(os.getcwd(),'..','chiquita','logo2.jpg')]
...
for loopCount in range(10):
	...
	for i in range(numImages):
		...
		#	print outFile
			...
			subprocess.call(['convert',srcFile,'+level',`level`,'-rotate',`angle`,'-morphology','Convolve','Comet:0x'+`cometVal`+'+'+`cometRot`,'-seed',`seedVal`,'-attenuate',`attVal`,'+noise','gaussian','-gravity','Center','-crop','32x64+0+0','+repage',outFile])
		elif index < 23:
			srcFile = srcFiles[index%6]
			index=6
			xoffset = random.randint(0,6) + 4
			yoffset = random.randint(0,9) + 6
